...
public class AutomationScheduleCreationAPI {
  ...
  private List<Long> testRunIds = null;
  ...
  **/
  ...
  public AutomationScheduleCreationAPI startDate(OffsetDateTime startDate) {
  ...
  **/
  ...
  public AutomationScheduleCreationAPI addTestRunIdsItem(Long testRunIdsItem) {
    if (this.testRunIds == null) {
      this.testRunIds = new ArrayList<Long>();
    }
   ...
   * @return testRunIds
  **/
  @ApiModelProperty(value = "Arrays of Test Run ID")
  ...
  public AutomationScheduleCreationAPI putDynamicItem(String key, String dynamicItem) {
    if (this.dynamic == null) {
      this.dynamic = new HashMap<String, String>();
    }
   ...
   * @return dynamic
  **/
  @ApiModelProperty(value = "Additions values")
